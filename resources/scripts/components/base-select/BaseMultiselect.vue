...
export default {
  ...
  props: {
    ...
    classes: {
      ...
      default: () => ({
        container:
          'p-0 relative mx-auto w-full flex items-center justify-end box-border cursor-pointer border border-gray-200 rounded-md bg-white text-sm leading-snug outline-hidden max-h-10 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100',
        containerDisabled:
        ...
        multipleLabel:
          'flex items-center h-full absolute left-0 top-0 pointer-events-none bg-transparent leading-snug pl-3.5',
        search:
          'w-full absolute inset-0 outline-hidden appearance-none box-border border-0 text-sm font-sans bg-white rounded-md pl-3.5 dark:bg-gray-900 dark:text-gray-100',
        ...
        placeholder:
          'flex items-center h-full absolute left-0 top-0 pointer-events-none bg-transparent leading-snug pl-3.5 text-gray-400 text-sm dark:text-gray-500',
        caret:
        ...
        dropdown:
          'max-h-60 shadow-lg absolute -left-px -right-px -bottom-1 border border-gray-300 mt-1 overflow-y-auto z-50 bg-white flex flex-col rounded-md dark:border-gray-700 dark:bg-gray-900',
        dropdownTop:
        ...
        group: 'p-0 m-0',
        groupLabel:
          'flex text-sm box-border items-center justify-start text-left py-1 px-3 font-semibold bg-gray-200 cursor-default leading-normal dark:bg-gray-800 dark:text-gray-200',
        groupLabelPointable: 'cursor-pointer',
        groupLabelPointed: 'bg-gray-300 text-gray-700 dark:bg-gray-700 dark:text-gray-100',
        ...
        optionPointed: 'text-gray-800 bg-gray-100 dark:bg-gray-800 dark:text-gray-100',
        optionSelected: 'text-white bg-primary-500',
        optionDisabled: 'text-gray-300 cursor-not-allowed dark:text-gray-600',
        optionSelectedPointed: 'text-white bg-primary-500 opacity-90',
        optionSelectedDisabled:
          'text-primary-100 bg-primary-500/50 cursor-not-allowed',
        noOptions: 'py-2 px-3 text-gray-600 bg-white dark:bg-gray-900 dark:text-gray-400',
        noResults: 'py-2 px-3 text-gray-600 bg-white dark:bg-gray-900 dark:text-gray-400',
        fakeInput:
