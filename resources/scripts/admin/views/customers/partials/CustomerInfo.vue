<template>
  <div
    class="pt-6 mt-5 border-t border-solid border-gray-200 dark:border-gray-800 lg:pt-8 md:pt-4"
  >
    <!-- Basic Info -->
    <BaseHeading>
    ...
    <BaseDescriptionList class="mt-5">
      ...
      >
        <p
          ...
          class="text-sm font-bold leading-5 text-black non-italic dark:text-gray-100"
        >
